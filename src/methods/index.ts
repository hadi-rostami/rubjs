...
class Methods {
  ...
  onChatUpdates(callback: (message: DecoratorsTypes.ChatUpdates) => void): void;
  onChatUpdates(
    filters: ((msg: DecoratorsTypes.ChatUpdates) => boolean)[],
    callback: (message: DecoratorsTypes.ChatUpdates) => void
  ): void;
  onChatUpdates(this: Client, arg1: any, arg2?: any): void {
    this.registerHandler("chat_updates", arg1, arg2);
  }

  onShowActivities(
    callback: (message: DecoratorsTypes.ShowActivities) => void
  ): void;
  onShowActivities(
    filters: ((msg: DecoratorsTypes.ShowActivities) => boolean)[],
    callback: (message: DecoratorsTypes.ShowActivities) => void
  ): void;
  onShowActivities(this: Client, arg1: any, arg2?: any): void {
    this.registerHandler("show_activities", arg1, arg2);
  }

  onShowNotifications(
    callback: (message: DecoratorsTypes.ShowNotifications) => void
  ): void;
  onShowNotifications(
    filters: ((msg: DecoratorsTypes.ShowNotifications) => boolean)[],
    callback: (message: DecoratorsTypes.ShowNotifications) => void
  ): void;
  onShowNotifications(this: Client, arg1: any, arg2?: any): void {
  ...
  ): Promise<GroupTypes.AddGroupMembers> {
  ...
  ): Promise<GroupTypes.BanGroupMember> {
  ...
  ): Promise<GroupTypes.CreateGroupVoiceChat> {
  ...
  ): Promise<GroupTypes.DeleteNoAccessGroupChat> {
  ...
  ): Promise<GroupTypes.GetBannedGroupMembers> {
  ...
  ): Promise<{ reactions: MessagesTypes.Reaction[] }> {
  ...
  ): Promise<MessagesTypes.SendMessageResult> {
  ...
  ): Promise<MessagesTypes.DeleteMessage> {
  ...
  ): Promise<MessagesTypes.EditMessage> {
  ...
  ): Promise<MessagesTypes.ForwardMessages> {
  ...
  ): Promise<MessagesTypes.GetMessagesBase> {
  ...
  ): Promise<MessagesTypes.GetMessagesInterval> {
  ...
  ): Promise<MessagesTypes.GetMessagesUpdates> {
  ...
  ): Promise<MessagesTypes.GetMessageShareUrl> {
  ...
  ): Promise<MessagesTypes.GetPollOptionVoters> {
  ...
  ): Promise<MessagesTypes.GetPollStatus> {
    return Messages.getPollStatus.apply(this, args);
  }

  async requestSendFile(
    this: Client,
    ...args: Parameters<typeof Messages.requestSendFile>
  ): Promise<MessagesTypes.RequestSendFile> {
  ...
  ): Promise<MessagesTypes.SetPinMessage> {
  ...
  async get(
    this: Client,
    ...args: Parameters<typeof Utilities.get>
  ): Promise<any> {
  ...
  async post(
    this: Client,
    ...args: Parameters<typeof Utilities.post>
  ): Promise<any> {
